package buttons
{
	...
	public class MoneyButton extends Button
	{
		...
		public var coinsIcon:Bitmap = new Bitmap();
		...
		public function MoneyButton(settings:Object = null)
		{
			...
			settings['countDY'] = settings.countDY || 0;
		...
		override protected function drawTopLayer():void
		{
			...
			if (settings.boostsec && settings.mID)
			{
				...
				/*switch (settings.mID){
				   ...
				   break;
				   case Stock.STOPWATCH:
				   coinsIcon = new Bitmap(UserInterface.textures.clock, "auto", true);
				   break;
				   case Stock.AMULET_EARTH:
				   coinsIcon = new Bitmap(Window.textures.amuletEarth, "auto", true);
				   break;
				   case Stock.AMULET_FIRE:
				   coinsIcon = new Bitmap(Window.textures.amuletFire, "auto", true);
				   break;
				   default:
			...
			else
			{
				...
				{
					//coinsIcon = new Bitmap(UserInterface.textures.goldenPearl, "auto", true);
					onLoad(new Bitmap(UserInterface.textures.goldenPearl, "auto", true));
				}
				else
				{
					//coinsIcon = new Bitmap(UserInterface.textures.blueCristal, "auto", true);
					onLoad(new Bitmap(UserInterface.textures.blueCristal, "auto", true));
				}
			}
		}
		...
		public function updatePos():void
		{
			...
			countLabel.y = (bottomLayer.height - countLabel.textHeight) / 2 + settings.countDY;
		...
		private function onLoad(data:Bitmap):void
		{
			...
			countLabel.y = coinsIcon.y + (coinsIcon.height - countLabel.textHeight) / 2 + settings.countDY;
