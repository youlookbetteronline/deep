package units 
{
	...
	public class Technological extends Share 
	{
		...
		static public const ARSENAL:uint = 2089;
		...
		public function Technological(settings:Object) 
		{
			...
			for (var i:String in info.devel.tech[3]) 
			{
				if (settings.technology) technologies[info.devel.tech[3][i]] = settings.technology[info.devel.tech[3][i]];
				if (!technologies[info.devel.tech[3][i]]) technologies[info.devel.tech[3][i]] = 0;				
				if (settings.tlevel) prizes[info.devel.tech[3][i]] = settings.tlevel[info.devel.tech[3][i]];
				if (prizes[info.devel.tech[3][i]] == undefined) prizes[info.devel.tech[3][i]] = -1;
			}
		}
			...
			else
			{
				if (App.user.mode == User.OWNER)
				{
					...
					new TechnologicalWindow( {
						...
						technologies:info.devel.tech[3],
						kickEvent:onKick
					}).show();
					return true;
				}
