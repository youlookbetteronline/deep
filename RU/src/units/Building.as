package units 
{
	...
	public class Building extends AUnit
	{
		...
		public static const ALWAYS_ANIMATED:Array = [183, 306, 500, 988, 1722, 1884, 1891, 1890, 1889, 1888, 2081, 2315, 2207, 2399, 2622, 2739, 2799, 2804, 2957, 3061, 3067, 3264, 3265, 3317];	// Постоянная анимация при окончании постройки
