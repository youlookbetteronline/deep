		...
		protected function updateAnim(e:Event = null):void 
		{
			...
			if (index > -1) {
				...
				if (animInfo[frameTypes[index]].chain[animInfo[frameTypes[index]].frame] != animInfo[frameTypes[index]].show) 
				{
					...
					if (params.animal || params.type == 'Walkgolden' ||params.type == 'Walkhero'|| params.type == 'Animal'|| params.type == 'Banker'|| params.type == 'Beast') {
		...
		public static function bounds(texture:Object, params:Object = null):Object {
			...
			if (texture.hasOwnProperty('animation') ) 
			{
				for (var anims:String in texture.animation.animations) 
				{
					...
					{
						var frame:Object = (params && params.type && (params.type == 'Walkgolden' || params.type == 'Walkhero' || params.type == 'Banker' || params.type == 'Animal' || params.type == 'Beast')) ? texture.animation.animations[anims].frames[0][_frame] :texture.animation.animations[anims].frames[_frame];
