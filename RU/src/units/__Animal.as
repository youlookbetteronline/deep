package units 
{
	...
	public class Animal extends WorkerUnit
	{
		...
		public function calculateShadow():void
		{
			...
			//if (sID == 455 ||sID == 452 ||sID == 453){depth_animal = 0; }
			...
			if (textures)
			{
				...
				ay = textures.animation.ay - depth_animal;// позиция битмапки персонажа 
			}
			//}
		}
		...
		override public function click():Boolean
		{
			...
			//if (this.cloudAnimal && this.cloudAnimal.visible == false)
				//return false;
