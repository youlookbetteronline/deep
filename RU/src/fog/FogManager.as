package fog 
{
	...
	public class FogManager 
	{
		...
		public static var fog01:Bitmap = new Bitmap(Window.textures.f3, "auto", true);
		public static var fog02:Bitmap = new Bitmap(Window.textures.f3, "auto", true);
		public static var fog03:Bitmap = new Bitmap(Window.textures.f3, "auto", true);
		public static var fog04:Bitmap = new Bitmap(Window.textures.f3, "auto", true);
		public static var fog05:Bitmap = new Bitmap(Window.textures.f3, "auto", true);
		
		public static var fog1:BitmapData = fog01.bitmapData;
		public static var fog2:BitmapData = fog02.bitmapData;
		public static var fog3:BitmapData = fog03.bitmapData;
		public static var fog4:BitmapData = fog04.bitmapData;
		public static var fog5:BitmapData = fog05.bitmapData;
		
		public var fogsImages:Array = [fog1, fog2, fog3, fog4, fog5];
		public var fogsImagesCoef:Array = [.8, .7, .6, .7, .8];
