package ui 
{
	...
	public class BottomPanel extends Sprite
	{
		...
		public var favoritePanel:Sprite;
		...
		public function resize():void 
		{
			...
			/*if (favoriteButton)
			{
				favoriteButton.y = App.self.stage.stageHeight - 80;
				favoriteButton.x = mainPanel.x - 105;
			}*/
		...
		/*public function drawFavoritePanel():void 
		{
			...
			favoriteButton.tip = function():Object{
				return{
					title:	Friends.inFavorite?'Удалить с избранных':'Добавить в избранные'
				}	
			}
		}
