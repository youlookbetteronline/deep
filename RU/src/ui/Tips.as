package ui
{
	...
	public class Tips extends Sprite
	{
		...
		private function draw():void {
			...
			if (text == '' && desc == '' && count1 == '' && count2 == '' && addDesc == '')
			{
				titleOnly = true;
			}else
			{
		...
		private function redrawBackGround(desc:int = 0):void {
			...
			maxWidth =  Math.max(titleLabel.textWidth, textLabel.textWidth, givesLabel.textWidth, descLabel.textWidth + iconW + iconW2 /*+ orDesc.width*/,countLabel.textWidth + iconW + iconW2 + descLabel.textWidth ,additionalDesc.textWidth) + padding;
