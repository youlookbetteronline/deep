package effects 
{
	...
	public class BoostEffect extends LayerX 
	{
		
		public var lights:Bitmap;
		public var text:TextField;
		
		public function BoostEffect(x:int = 0, y:int = 0,ener:Boolean = false) {
			...
			var bitmap2:Bitmap = new Bitmap(Window.textures.glowingBackingNew, 'auto', true);
			...
			{
			/*icon = new Bitmap();
			Load.loading(Config.getIcon("Vip", 'energy_boost'), onLoad);
	...
	//	icon.y = -icon.height / 2;
		...
		public function show(text:*, notFormat:Boolean = false):void {
			if (notFormat) 
			{
