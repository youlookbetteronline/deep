package wins 
{
	...
	{		
		...
		public function drawBonus():void 
		{
			...
			if (bonusListBacking && bonusListBacking.parent)
				bonusListBacking.parent.removeChild(bonusListBacking)
		...
		public function showTake(dID:uint):void {
			for (var i:String in App.data.daylics[dID].bonus) 
			{
				...
				item.cashMove(new Point(point.x, point.y), App.self.tipsContainer);
			}
		}
