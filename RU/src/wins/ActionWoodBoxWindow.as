package wins
{
	...
	public class ActionWoodBoxWindow extends AddWindow
	{
		...
		{ 
			...
			var priceLable:Object = ActionsHelper.priceLable(count);
			var oldPriceLabel:TextField = drawText( Locale.__e(priceLable.text, [priceLable.price]), {
				fontSize	:40,
				autoSize	:'left',
				textAlign	:"center",
				color		:0xffffff,
		...
		public function drawPrice():void
		{
			...
			var bttnSettings:Object = {fontSize: 32, width: 186, height: 75 + 10 * int(App.isJapan())};
