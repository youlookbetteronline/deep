package wins 
{
	...
	public class BathyscaphePayWindow extends Window 
	{
		...
		override public function drawBody():void {
			...
			if (!App.user.hasOwnProperty('bathyscaphe') || !App.user.bathyscaphe.hasOwnProperty('currentThrow') ||App.user.bathyscaphe.currentThrow < App.data.storage[worldID].fuel)
...
{	
	...
	{
		var count:String = (App.user.hasOwnProperty('bathyscaphe') && App.user.bathyscaphe != null && App.user.bathyscaphe.hasOwnProperty('currentThrow')) ? String(App.user.bathyscaphe.currentThrow) : '0';
		_count = Window.drawText(count + '/' + String(App.data.storage[_settings.wID].fuel),{
			fontSize		:30,
			color			:0xffffff,
