package wins
{
	...
	public class HeroWindow extends Window
	{
		...
		public function HeroWindow(settings:Object = null) 
		{
			...
			if (App.user.sex == 'w' && App.social == 'FS')
				saveSttings.sex = 'f'
		...
		/*	if (tutorialMode) {
				heroDY = -34;
				titleLabel.width = settings.width - 30;
			...
			if (hero.textures) hero.startAnimation();
			hero.x = heroBg.x + 65;
			hero.y = heroBg.y + 120;
		    ...
		    //back.x = heroDX - (sexBg.width) / 2;
		    //back.y = sexLabel.y + sexLabel.height - 4;
