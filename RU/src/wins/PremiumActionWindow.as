package wins 
{
	...
	public class PremiumActionWindow extends Window
	{
		...
		override public function drawBody():void 
		{
			...
			backShape = new Shape();
			backShape.graphics.beginFill(0x05749a);
			backShape.graphics.drawRect(0, 0, settings.width - 20, settings.height - 20);
			backShape.x = (settings.width - backShape.width) / 2;
			backShape.y = settings.height - backShape.height - 5;
			backShape.graphics.endFill(); 
			layer.addChildAt(backShape, 0);
			...
			if (action.hasOwnProperty('picture'))
			{
				...
				layer.swapChildren(pic, backShape);
