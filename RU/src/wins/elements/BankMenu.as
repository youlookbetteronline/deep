package wins.elements 
{
	...
	public class BankMenu extends Sprite
	{
		...
		public var menuSettings:Object = {
				...
				1: {type:'Coins', order:1,	title:Locale.__e('flash:1409322691735') },
		...
		public function BankMenu(window:*)
		{
						...
						var settings:Object = menuSettings[item];
							...
							switch(settings.type) {
								case BanksWindow.REALS:
									settings["bgColor"] = [0x99cbfe, 0x5c87ef];
									settings["bevelColor"] = [0xb5dbff, 0x386cdc];
									settings["fontBorderColor"] = 0x38499b;
									settings["fontCountColor"] = 0xFFFFFF;
									settings["fontCountBorder"] = 0x354321;
									settings["fontBorderSize"] = 3;
									settings['active'] = {
										bgColor:				[0x5c87ef, 0x99cbfe],//[0x47750b,0x74bc17],
										bevelColor:				[0x386cdc, 0xb5dbff],//[0x335309,0x7ecb19],	
										fontBorderColor:		0x38499b				//Цвет обводки шрифта
									}
								break;
			...
			this.x = 164;//(window.settings.width - submenuBg.width) / 2;
			this.y = 0;
		}
