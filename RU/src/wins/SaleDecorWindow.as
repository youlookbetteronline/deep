package wins 
{
	 ...
	 * @author ...
	 */
	public class SaleDecorWindow extends AddWindow 
	{
		...
		override public function drawBody():void
		{
			...
			drawMirrowObjs('diamonds', 20, settings.width - 15, settings.height - 125,false,false,false,1,1);
			drawMirrowObjs('diamonds', 20, settings.width - 15, 40, false, false, false, 1, -1);
		...
		{
			var timeBg:Bitmap = backingShort(165, 'timeBg');
...
internal class DecorItem extends Sprite {
		...
		private function drawText():void
		{
			...
			while (description.textHeight > 100) {
				var _texts:Array = description.text.split(' ');
				_texts.pop();
				description.text = _texts.join(' ') + '...';
			}
