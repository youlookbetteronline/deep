package wins.table 
{
	...
	public class SellMaterialWindow extends SelectMaterialWindow 
	{
		...
		override public function drawSellPrice():void 
		{
			...
			{
				currentMaterialIcon = new RewardItem(priceFactor.materialID, price * priceFactor.factor, null, 60, "", 0.74, 0, 0, true, true);
				currentMaterialIcon.x = open.x + (open.width / 2) - (currentMaterialIcon.width / 2);
...
internal class RewardItem extends LayerX
{
	...
	{			
		...
		text.x = (bg.width - text.width) * 0.5 - 100;
		text.y = bg.height + 75;
