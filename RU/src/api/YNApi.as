	...
	public class YNApi
	{
		...
		public var dictionary:Object = {
			...
			6: function(sID:uint):Object {
					return{								
						title:Locale.__e("flash:1421760985364"),
						url:Config.getImage('mail', 'achiev', 'jpg')
					}
			},
			...
			8: function(sID:uint):Object {
					return{				
						title:Locale.__e("flash:1407155160192"),
		...
		public function YNApi(flashVars:Object)
		{
			...
			Log.alert( [flashVars.gameId, "yahoo"]);
			Log.alert({ 
			...
			PlayerIO.authenticate(App.self.stage, flashVars.gameId, "yahoo", { 
				userId:flashVars.viewer_id,
				userToken:flashVars.usertoken
			}, null, function(client:*):void{
				that.client = client;
				//Refresh Yahoo data
				friends = { };
