package core 
{
	...
	public class Load 
	{
		...
		public static function clearAllCache():void {
			/*for (var hash:String in cache){
				for each(var _callback:Function in cache[hash].callbacks){
					_callback = null;
				}
				clearVariable(cache[hash].data);
				delete cache[hash];
			}
