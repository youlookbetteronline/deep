package {
	...
	[SWF ( width="1600", height="700", backgroundColor="#062b46", allowsFullScreen = true) ]
	...
	public class  MainPreloader extends Sprite
	{
		...
		[Embed(source="start_screen_NY.jpg")]
		...
		{	
			...
			mainLogoDeep.y = stage.stageHeight - mainLogoDeep.height - 120;
			...
			barBack.y = stage.stageHeight - barBack.height - 40;
