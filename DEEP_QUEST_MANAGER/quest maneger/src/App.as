package 
{
	...
	[SWF ( width = "1600", height = "700", allowsFullScreen = true, backgroundColor = '#1a6953') ]
	...
	public class App extends Sprite 
	{
		...
		*/
		...
		public static var startQest:uint = 1; // 
		...
		private function initContent():void 
		{
			...
			searchPanel.x = stage.stageWidth - searchPanel.width - 20;
		...
		private var summLevelLabel:TextField;
		...
		private function drawUpButtons():void 
		{
			...
			bttnNavigate = new ImageButton(Textures.textures.navIco,{tip:{title:'Навигатор!',	text:'Вкл./Выкл.'}});
			addChild(bttnNavigate);
			bttnNavigate.x = 126;
			bttnNavigate.y = 3;
			bttnNavigate.addEventListener(MouseEvent.CLICK, onNavigate);
			
			summLevelLabel = UI.drawText(String(summLevel), {
				fontSize		:26,
				color			:0xff0000,
			...
			summLevelLabel.x = 175;
			summLevelLabel.y = 0;
			addChild(summLevelLabel);
		...
		private function onKeyDown(e:KeyboardEvent):void 
		{
			...
			/*if (e.keyCode == Keyboard.NUMBER_9){
				summLevel = 9;
				summLevelLabel.text = String(summLevel);
			}
		...
		private function onMouseDown(e:MouseEvent):void 
		{
			...
			for each(var _under:Object in under)
			{
				...
				if ((_under.parent.parent) && (_under.parent.parent.parent) && _under.parent.parent.parent is ComboBox)
				{
					treeManeger.startDrag = true;
				}
			}
