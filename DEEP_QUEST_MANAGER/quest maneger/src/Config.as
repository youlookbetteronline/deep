package
{
	...
	public class Config
	{
		...
		public static function setServersIP(parameters:Object = null):void
		{
			...
			switch(App.social) {
				case "MDM":
					_mainIP	= mainIP != null ? mainIP : ['m.deep.islandsville.com', 'm.deep.islandsville.com'];
					break;
				case "AND":
					_mainIP	= mainIP != null ? mainIP : ['dp-mob1.islandsville.com', 'dp-mob1.islandsville.com'];
					break;
				case "DM":
				...
				case "SP":
					...
					break;
				case "AM":
					_mainIP	= mainIP != null ? mainIP : ['dp-am1.islandsville.com', 'dp-am1.islandsville.com'];	
					break;
				case "AMD":
