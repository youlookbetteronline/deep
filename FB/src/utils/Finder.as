package utils 
{
	...
	public class Finder 
	{
		...
		public static function nearestUnit(unit:*, targets:Array = null):*
		{
			...
			var currentPos:Object = {x:unit.coords.x, z:unit.coords.z};
		...
		public static function findUnitsOnMap(sid:*):void
		{
			var unts:Array = Map.findUnits([sid]);
			if (unts.length > 0)
			{
				var unit:Unit = unts[0];
				Window.closeAll();
