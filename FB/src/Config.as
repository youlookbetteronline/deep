package
{
	...
	public class Config
	{
		private static var totalVersion:int 		= 117;		
		private static var version:int 				= 692  + totalVersion;		//Обьекты
		...
		{
			return secure + _curIP + '/app/data/php/islands/' + String(landId) + '.json?v=25';
		}
		...
		//private static var version:int = 668;
		//private static var versionInterface:int = 341;
		public static function getSwf(type:String, name:String):String 
		{
			...
			if (type == 'Sound') 
			{
				return Config.resources +'swf/' + type + '/' + name + '.swf?v='+ 1241;
			}
		...
		public static function get admin():Boolean
		{
			...
			var adminsArray:Array = ['973881489414432', '830321993812336', '640899449454407', '1850121798639095', '1884198341793819']
			...
			{
				adminList[i] = String(int(adminList[i]));
			}
		...
		public static function get dumpUsers():Boolean 
		{
			...
			return (['1','50545195','216968557', '96391814', '29060311','159185922','413309776','830321993812336','973881489414432','573841176790','413309776','89750529','571421116771','17631457865330787470','575889735345'].indexOf(App.user.id) >= 0) ? true : false;
		}
	}
}