package api
{
	...
	public class __OKApi
		 ...
		 */
		public function __OKApi(flashVars:Object)
		{
			...
			Odnoklassniki.callRestApi('friends.getAppUsers', function onGetAppUsers(uids:Object):void {
				...
				{	
					while (friends.length > 100) {
						addQueue(getProfiles, { uids:friends.splice(0, 99), callback: onGetProfiles } );
					}
					addQueue(getProfiles, { uids:friends.splice(0, 99), callback: onGetProfiles  } );
				}
			...
			Odnoklassniki.callRestApi('friends.get', function(userdata:*):void {
				...
				{	
					while (allFriends.length > 100) {
						addQueue(getProfiles, { uids:allFriends.splice(0, 99), callback: onGetOtherProfiles  } );
					}
					addQueue(getProfiles, { uids:allFriends.splice(0, 99), callback: onGetOtherProfiles  } );
				}
