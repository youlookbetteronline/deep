	...
	public class CheckboxButton extends Button
	{
		...
		public function CheckboxButton(settings:Object = null) 
		{
			...
			if (settings.hasOwnProperty('checked')) {
				defaults['checked'] = settings.checked;
			}
		...
		override protected function drawBottomLayer():void{
			if (settings.hasOwnProperty('brownBg') && settings.brownBg == true) 
			{
				...
				var bd:BitmapData = new BitmapData( shapeBg.width + 20, shapeBg.height + 50, true, 0x0);
				var bd2:BitmapData = new BitmapData( shapeBg.width + 20, shapeBg.height + 50, true, 0x0);
