package wins 
{
	...
	public class MoneyHouseWindow extends Window
	{
		...
		private function drawDesc():void 
		{
			...
			var moneyIcon:Bitmap = new Bitmap(UserInterface.textures.goldenPearl);
		...
		public function putFriendInto(id:int):void
		{
...
internal class FriendItem extends Sprite {
	...
	public function FriendItem(window:MoneyHouseWindow, id:int, numOfRoom:int, closed:Boolean = false, callBack:Function = null) 
	{
		friendId = id;
		numRoom = numOfRoom;
	...
	private function drawReward():void
	{
		...
		var coin:Bitmap = new Bitmap(UserInterface.textures.blueCristal);
