...
internal class BigsaleItem extends LayerX {
		...
		public function drawCount():void {
			...
			switch(App.social) {
				...
				case "PL":
				case "YB": text = 'flash:1421404546875';
					break;
				case "MX":
						text = "%d pt.";
						/*textSettings['borderColor'] = [0xffca8a, 0xc4690b];
			...
			var priceLabel2:TextField = Window.drawText(Locale.__e(text, [price_new]), settings);
		...
		//	addChild(priceLabel2);
			priceBttn.caption = Locale.__e(text, [price_new]);
			...
			var priceLabel1:TextField = Window.drawText(Locale.__e(text, [price_old]), {
				fontSize	:26,
				autoSize	:'left',
				textAlign	:"center",
				color		:0x7e3e13,
			...
			redLine.y = priceLabel1.y + priceLabel1.textHeight - redLine.height - 2;
			redLine.rotation = 11;
			...
			switch(App.social) {
				...
				//case "MX":
				//case "AI":
					/*var crystals1:Bitmap = new Bitmap(UserInterface.textures.blueCristal, "auto", true);
					var crystals2:Bitmap = new Bitmap(UserInterface.textures.blueCristal, "auto", true);
					
					addChild(crystals1);
					addChild(crystals2);
						
					crystals1.scaleX = crystals1.scaleY = 28/crystals1.width;//нижняя
					crystals2.scaleX = crystals2.scaleY = 28/crystals2.width;//верхняя
					
					crystals1.x = priceLabel1.x + priceLabel1.width + 4;
					crystals1.y = priceLabel1.y + 45;
					crystals2.x = priceLabel2.x + priceLabel2.width + 10;
					crystals2.y = priceLabel2.y + 20;*/
					break;
				default: 
					break;
			}
			...
			/*var startCoords:Object = {
				x: (App.isSocial('MX')) ? mixiLogo1.x - 1 : priceLabel1.x - 1,
				y:priceLabel1.y + 1
			}
			
			var endCoords:Object = {
				x:(App.isSocial('MX')) ? priceLabel1.x + priceLabel1.width + 1: priceLabel1.x + priceLabel1.width + delta  + 1,
