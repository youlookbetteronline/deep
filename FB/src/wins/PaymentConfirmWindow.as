package wins 
{
	...
	public class PaymentConfirmWindow extends Window 
	{
		...
		override public function drawBackground():void {
			background = backing(settings.width, settings.height, 30, 'paperBacking');
		...
		override public function drawBody():void 
		{
			...
			Load.loading(
				...
				function(data:Bitmap):void{
					...
					diamond.scaleX = diamond.scaleY = 0.5;
			...
			denyBttn.y = background.y + background.height - denyBttn.height - 35;
