package wins
{
	...
	public class RewardListB extends Sprite 
	{
		...
		public function RewardListB(bonus:Object, hasBacking:Boolean = true, widthBacking:int = 0, params:Object = null, text:String = "flash:1383056749229")
		{
			if (!params) params = { };
...
internal class RewardItem extends LayerX
{
	...
	private function onLoad(data:Bitmap):void
	{
		...
		icon.x = bg.width * 0.5 - icon.width * 0.5;
		icon.y = bg.height * 0.5 - icon.height * 0.5;
		addChild(icon);
		
		if (text) {
			text.x = bigBlink ? bg.width * 0.9 : bg.width - text.width;
