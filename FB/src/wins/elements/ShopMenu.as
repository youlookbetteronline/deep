package wins.elements 
{
	...
	public class ShopMenu extends Sprite
	{
		...
		private static function getMenuSettings():Object {
			return {
		...
		public function ShopMenu(window:ShopWindow)
		{
			...
			switch (App.user.worldID){
				case User.HOLIDAY_LOCATION:
					//if (App.time+10 > ShopWindow.easterTimeEnd)
					arrSquence = [100, 4, 3, 13, 7];
					//else
						//arrSquence = [100, 3, 13, 7, 14];
				break;
				
				case User.TRAVEL_LOCATION:
					arrSquence = [100, 2, 15, 7];
					break;
				...
				case 3148: 
					...
					break;	
				case 3184: 
					arrSquence = [100, 2, 13, 4, 3, 7];
					break;
				case 3253: 
					arrSquence = [100, 3, 4, 7, 2, 15];
					break;
				case 3333: 
				...
				default: 
						arrSquence = [100, 4, /*14, */2, 15, 3, 13, 7/*, 18*/];
					break;
			}
