package  
{
	...
	public class Load 
	{
		...
		// Load file
		public static function openAsync(file:File, callback:Function = null):void {
			...
			function dispose():void {
				if (fs.hasEventListener(Event.COMPLETE)) {
					fs.removeEventListener(Event.COMPLETE, onComplete);
					fs.removeEventListener(IOErrorEvent.IO_ERROR, onError);
				}
			}
		}
